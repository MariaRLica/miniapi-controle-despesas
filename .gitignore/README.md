...
API desenvolvida em **Python + Flask**, como parte do TDE — Módulo 1 (Organização e Versionamento de Software).  
Permite gerenciar despesas, categorias e visualizar relatórios financeiros.
